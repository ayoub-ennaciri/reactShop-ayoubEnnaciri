...
import images from "../assets/images/logo/logo.png.webp";
...
export function Navbar() {
  return (
    <div className="h-20 flex items-center justify-between px-13">
      ...
      <div>
        <ul className="hidden sm:flex gap-9 text-[17px] font-stretch-50% font-[350]">
      ...
      <div className="hidden sm:flex items-center gap-10 text-[#C7C7C7]">
        <NavLink
          to="/account"
          className={({ isActive }) =>
